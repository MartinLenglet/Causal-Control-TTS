function figure_counter = disp_controlability_by_layer( ...
...
%     plot(1:nbr_layers, zeros(1,nbr_layers), 'k--', 'LineWidth', 3);
    plot(xlimits, 3*ones(1,2), 'r-.', 'LineWidth', 1,'HandleVisibility','off');
...
%     xticklabels([]);
    ...
    if i_model == nbr_models
        ...
        legend([params_to_control(list_params_supra_segmental,1); {'R²: 0.1'; 'R²: 0.5'; 'R²: 1'}], 'Location','southeast');
    end
    grid on;
